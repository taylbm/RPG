...
namespace rpg
{
        ...
        //
	{
        ...
        //
        {
	    scope in_ca = class_<controlauth_ns>("controlauth");
	    in_ca.attr("CA_REMOTE_CONTROL_ENABLED") = CA_REMOTE_CONTROL_ENABLED;
	    in_ca.attr("CA_LOCAL_CONTROL_REQUESTED") = CA_LOCAL_CONTROL_REQUESTED;
	}
        //
        // RDA aux/gen status
        //
